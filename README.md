...
**addon for**: [Blender](http://blender.org) version *2.82* and below. For *2.79* see [special installation instruction](https://github.com/nortikin/sverchok/wiki/Sverchok-for-Blender-2.79-installation).  
