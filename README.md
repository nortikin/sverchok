...
Программирование сетки и геометрии состоит из "кирпичей":  
  ...
  - матрицы (удобный и понятный инструмент изменения положениеа-масштаба-поворота)
...
Не установилось? Список причин [here](/docs/Installation_troubleshooting.md). Если вашей ошибки там нет - пишите письма.
