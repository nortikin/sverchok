...
class SverchokPreferences(AddonPreferences):
    ...
    show_icons_in_dynamic_menu = BoolProperty(
        default=0,
        description="some people do not like blender icons, this option is off by default")
    ...
    def draw(self, context):
        ...
        col.prop(self, "show_icons_in_dynamic_menu", text="use blender icons in menu")
