...
class SvExCurveRangeNode(SverchCustomTreeNode, bpy.types.Node):
    """
    ...
    replacement_nodes = [('SvExCurveRangeNodeMK2', dict(Curve='curves', ), dict(TMin='tmin', TMax='tmax', Range='range'))]
