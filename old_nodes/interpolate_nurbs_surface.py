...
from sverchok.utils.surface.nurbs_algorithms import interpolate_nurbs_surface_piegl as interpolate_nurbs_surface
...
class SvExInterpolateNurbsSurfaceNode(SverchCustomTreeNode, bpy.types.Node):
    ...
    replacement_nodes = [('SvExInterpolateNurbsSurfaceNodeMK2', None, None)]
