...
from sverchok.utils.surface.nurbs_algorithms import nurbs_sweep
...
class SvNurbsSweepNode(SverchCustomTreeNode, bpy.types.Node):
    ...
    replacement_nodes = [('SvNurbsSweepMk2Node', None, None)]
    ...
    if FreeCAD is not None:
        implementations.append((SvNurbsMaths.FREECAD, "FreeCAD", "FreeCAD implementation", 2))
