...
.. image:: https://github.com/user-attachments/assets/193754b3-02e2-4326-b9b0-e38f5cb74de8
  :target: https://github.com/user-attachments/assets/193754b3-02e2-4326-b9b0-e38f5cb74de8
...
+--------------------+---------------------------------------------------------------+-----------------------+-------------+
|**Contain**         | Whether the text contains a substring                         |                       |             |
+--------------------+---------------------------------------------------------------+-----------------------+-------------+
|**Contain (re)**    | Whether the text contains a substring with regular expression |                       |             |
+--------------------+---------------------------------------------------------------+-----------------------+-------------+
|**Count**           | Returns the number of times a specified value occurs in a     |                       | Number      |
|                    | string                                                        |                       |             |
+--------------------+---------------------------------------------------------------+-----------------------+-------------+
|**Count (re)**      | value is regular expression                                   |                       | Number      |
+--------------------+---------------------------------------------------------------+-----------------------+-------------+
|**Replace**         | Returns a string where a specified value is replaced with a   | 'Find', 'Replace'     | String      |
|                    | specified value                                               | 'Count': -1 = all     |             |
+--------------------+---------------------------------------------------------------+-----------------------+-------------+
|**Replace (ex)**    | Replace substring with regular expression                     | 'Find', 'Replace'     | String      |
+--------------------+---------------------------------------------------------------+-----------------------+-------------+
...
Reqular Expressions examples
----------------------------

.. image:: https://github.com/user-attachments/assets/2d584c8d-7cb1-4d8a-b061-0c5d6834e36f
  :target: https://github.com/user-attachments/assets/2d584c8d-7cb1-4d8a-b061-0c5d6834e36f

See Python regular expression syntax: https://docs.python.org/3/library/re.html