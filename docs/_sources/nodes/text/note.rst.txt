...
Functionality
-------------
Note node allow show custom text and convert custom text to format naming indices of viewer_INDX. For last writing words separated with spaces will be i.e.:
...
| Input           | Description                                                              |
+=================+==========================================================================+
| Text_in         | Input text to show or convert to mark indices                            |
+-----------------+--------------------------------------------------------------------------+
