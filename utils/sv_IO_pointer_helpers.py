...
def unpack_pointer_property_name(datablock, data_kind, node_ref, key_name):
    """
    ...
    input:
        datablock  : the attribute on the current node that we want to set
