...
class VectorPolarOutNodeMk2(bpy.types.Node, SverchCustomTreeNode, SvRecursiveNode):
    '''Get cylindrical or spherical coordinates from vectors'''
    bl_idname = 'VectorPolarOutNodeMk2'
    bl_label = 'Vector polar output2'
    ...
    def sv_init(self, context):
        self.width = 100
        vs = self.inputs.new("SvVerticesSocket", "Vectors")
...
def register():
    bpy.utils.register_class(VectorPolarOutNodeMk2)


def unregister():
    bpy.utils.unregister_class(VectorPolarOutNodeMk2)
