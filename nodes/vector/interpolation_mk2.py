...
class SvInterpolationNodeMK2(SverchCustomTreeNode, bpy.types.Node):
    '''Bi-dimensional interp. '''
    bl_idname = 'SvInterpolationNodeMK2'
    bl_label = 'Vector Interpolation UV'
    ...
    directions = [
        ...
        ('U', 'U', "One direction", 1)]
    direction: EnumProperty(name='Direction', default='U', items=directions, update=updateNode)
    ...
    def sv_init(self, context):
        ...
        self.inputs.new('SvStringsSocket', 'IntervalX').prop_name = 't_in_x'
        self.inputs.new('SvStringsSocket', 'IntervalY').prop_name = 't_in_y'
