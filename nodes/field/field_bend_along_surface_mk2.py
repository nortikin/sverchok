...
class SvExBendAlongSurfaceFieldNodeMK2(SverchCustomTreeNode, bpy.types.Node):
    """
    Triggers: Bend surface
    Tooltip: Generate a vector field which bends the space along the given surface.
    """
    bl_idname = 'SvExBendAlongSurfaceFieldNodeMK2'
...
def register():
    bpy.utils.register_class(SvExBendAlongSurfaceFieldNodeMK2)

def unregister():
    bpy.utils.unregister_class(SvExBendAlongSurfaceFieldNodeMK2)
