...
class SvRandomizeNode(bpy.types.Node, SverchCustomTreeNode):
    ''' Randomize '''
    bl_idname = 'SvRandomizeNode'
    bl_label = 'Randomize'
...
def register():
    bpy.utils.register_class(SvRandomizeNode)


def unregister():
    bpy.utils.unregister_class(SvRandomizeNode)
