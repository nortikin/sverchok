...
class SvBMOpsNode(bpy.types.Node, SverchCustomTreeNode):
    ...
    PV = ['remove_doubles(bm,verts=e,dist=v[0])',
          ...
          'join_triangles(bm,faces=e,cmp_sharp=v[0],cmp_uvs=v[1],cmp_vcols=v[2],cmp_materials=v[3],limit=v[4])',
          ...
          'edgenet_fill(bm, edges=e, mat_nr=v[0], use_smooth=v[1], sides=v[2])',
