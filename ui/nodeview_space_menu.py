...
class NODEVIEW_MT_Dynamic_Menu(bpy.types.Menu):
    ...
    def draw(self, context):
        ...
        layout.separator()
        layout.menu("NODEVIEW_MT_AddNumber", **icon('FONTPREVIEW'))
        layout.menu("NODEVIEW_MT_AddVector", **icon('MAN_TRANS'))
        layout.menu("NODEVIEW_MT_AddMatrix", **icon('AXIS_SIDE'))
        layout.menu("NODEVIEW_MT_AddLogic", **icon("FILTER"))
